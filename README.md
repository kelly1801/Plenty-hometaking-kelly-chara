...
-   See a list of their shortened links, even after refreshing the browser (browser cache solutions like localStorage are fine)
...
-   Testing is not required, but please include a short note about how you'd plan to test this if you had more time.
...
Thank you so much for taking the time to interview with us. We look forward to seeing what you create!

If you run into any issues or have any questions, please don't hesitate to reach out to Channing at channing@withplenty.com.